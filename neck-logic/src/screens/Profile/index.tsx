...
export default function ProfileScreen() {
    ...
    const stats = [
        { label: t('profile.totalXp'), value: currentXp.toString(), icon: Flame, color: '#00D9FF' },
        { label: t('profile.level'), value: currentLevel.toString(), icon: Trophy, color: '#A855F7' },
        { label: t('profile.streak'), value: `${currentStreak} ${t('profile.days')}`, icon: Zap, color: '#10B981' },
    ];
                  ...
                  >
                      <View className="flex-row items-center">
                          ...
                          <View className="ml-3">
                              ...
                              <Text className="text-sm text-muted-foreground mt-0.5 tracking-widest">
                                  {(tuning || ['E', 'A', 'D', 'G', 'B', 'E']).join(' ')}
                              </Text>
                          </View>
                      </View>
